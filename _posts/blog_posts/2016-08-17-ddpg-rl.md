...
You'll want to add book-keeping to the code and arrange things a little more neatly- you can see the full code at: https://gist.github.com/pemami4911/27a6b38a8a161adeaca0cc7ec1363480.
...
Despite running DDPG on the CPU of my Macbook Air, it converged relatively quickly to a good solution. Some ways to potentially see better performance:

1. Use a priority algorithm for sampling from the replay buffer instead of uniformly sampling. See my summary of [http://pemami4911.github.io/paper_summaries/2016/01/26/prioritizing-experience-replay.html].
